...
require("./modules/amount-card-in-cart.js");
...
},{"./modules/address.js":2,"./modules/amount-card-in-cart.js":3,"./modules/card.js":4,"./modules/delivery-date.js":6,"./modules/modal.js":8,"./modules/payment.js":10,"./modules/product-show.js":12,"./modules/validator.js":15}],2:[function(require,module,exports){
"use strict";
...
var starInBusket = document.querySelector('.delivery-type__star');
...
},{"./mock":7}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateAmountCardCart = void 0;
var _mock = require("./mock");
var productCardContainer = document.querySelector('.product__card-container');
var updateAmountCardCart = function updateAmountCardCart(place) {
  if (_mock.CARDS) {
...
exports.updateAmountCardCart = updateAmountCardCart;

},{"./mock":7}],4:[function(require,module,exports){
"use strict";
...
var _amountCardInCart = require("./amount-card-in-cart.js");
...
var cardNotAvalibleTemplateMobile = document.querySelector('#mobile-not-avalible-card').content.querySelector('.mobile-not-avalible-card');
var makerCardTemplate = document.querySelector('#maker').content.querySelector('.maker');
var cardMobileTemplate = document.querySelector('#mobile-card').content.querySelector('.mobile-card');
var amountNotAvalibleCard = document.querySelector('.no-avalible__amount');
var cardContainer = document.querySelector('.product__card-container');
var notAlalibleCardContainer = document.querySelector('.no-avalible__card-container');
var choseAllButton = document.querySelector('.check-all-card');
var headerCart = document.querySelector('.header__cart-link');
var tabbarCart = document.querySelector('.tabbar__cart');
...
var chooseAll = function chooseAll() {
  var checkboxs = cardContainer.querySelectorAll('input');
  checkboxs.forEach(function (element) {
    element.checked = true;
  });
};
var unChooseAll = function unChooseAll() {
  var checkboxs = cardContainer.querySelectorAll('input');
  checkboxs.forEach(function (element) {
    element.checked = false;
  });
};
choseAllButton.addEventListener('change', function () {
  if (choseAllButton.checked) {
    chooseAll();
  } else {
    unChooseAll();
  }
  (0, _total.updateTotalPrice)('.card');
});
...
var getDeleteCard = function getDeleteCard(card) {
  card.querySelector('.card__delete').addEventListener('click', function (evt) {
    ...
    (0, _amountCardInCart.updateAmountCardCart)(headerCart);
  }, true);
};
...
var updateAmountCard = function updateAmountCard(amount) {
  amountNotAvalibleCard.textContent = " \xB7 ".concat(amount, " \u0442\u043E\u0432\u0430\u0440\u0430");
};
var getCard = function getCard(element) {
  ...
  cardElement.querySelector('.card__img').srcset = "img/cards/".concat(element.id, "-product.jpg, img/cards/").concat(element.id, "-product2x.jpg 2x");
...
var getMobileDeleteNotAvalibleCard = function getMobileDeleteNotAvalibleCard(card) {
  card.querySelector('.not-avalible-card__delete').addEventListener('click', function (evt) {
...
var getNotAvalibleCard = function getNotAvalibleCard(element) {
  ...
  cardElement.querySelector('.not-avalible-card__img').srcset = "img/cards/".concat(element.id, "-product.jpg, img/cards/").concat(element.id, "-product2x.jpg 2x");
...
var renderCards = function renderCards(cards, place) {
  ...
  avalibleCards.forEach(function (card) {
    ...
    (0, _total.setSelectedCardListiner)(newCard, '.card');
  });
...
var getMobileCardProperties = function getMobileCardProperties(card, properties) {
  var propertisContainer = card.querySelector('.mobile-card__propirties-container');
  properties.forEach(function (element) {
    var newPropertis = document.createElement('span');
...
var getSpecialMobileProperti = function getSpecialMobileProperti(card, properti) {
  if (properti) {
    var special = card.querySelector('.mobile-card__propirties-special');
    special.textContent = properti;
  } else {
    card.querySelector('.mobile-card__propirties-special').remove();
  }
};
var getMobileCard = function getMobileCard(element) {
  var cardElement = cardMobileTemplate.cloneNode(true);
  setCardDataId(cardElement, element);
  cardElement.querySelector('.mobile-card__img').src = "img/cards/".concat(element.id, "-product.jpg");
  cardElement.querySelector('.mobile-card__img').srcset = "img/cards/".concat(element.id, "-product.jpg, img/cards/").concat(element.id, "-product2x.jpg 2x");
...
var renderMobileCards = function renderMobileCards(cards, place) {
  var fragment = document.createDocumentFragment();
  var avalibleCards = getAvalibleCards(cards);
  avalibleCards.forEach(function (card) {
    var newCard = getMobileCard(card);
    (0, _counter.addCounter)(newCard);
    getDeleteCard(newCard);
    fragment.append(newCard);
    (0, _total.setSelectedCardListiner)(newCard, '.mobile-card');
  });
  place.append(fragment);
};
var getNotAvalibleCardMobile = function getNotAvalibleCardMobile(element) {
  var cardElement = cardNotAvalibleTemplateMobile.cloneNode(true);
  setCardDataId(cardElement, element);
  cardElement.querySelector('.mobile-not-avalible-card__img').src = "img/cards/".concat(element.id, "-product.jpg");
  cardElement.querySelector('.mobile-not-avalible-card__img').srcset = "img/cards/".concat(element.id, "-product.jpg, img/cards/").concat(element.id, "-product2x.jpg 2x");
  cardElement.querySelector('.mobile-not-avalible-card__title').textContent = element.title;
  getSpecialMobileProperti(cardElement, element.specialProperti);
  getMobileCardProperties(cardElement, element.mobilePropertis);
  return cardElement;
};
var renderMobileNotAvalibleCards = function renderMobileNotAvalibleCards(cards, place) {
  var fragment = document.createDocumentFragment();
  var notAvalibleCards = getNotgetAvalibleCards(cards);
  notAvalibleCards.forEach(function (card) {
    var newCard = getNotAvalibleCardMobile(card);
...
var clearAllCards = function clearAllCards() {
  document.querySelector('.no-avalible__card-container').innerHTML = '';
  cardContainer.innerHTML = '';
};
var renderActualCards = function renderActualCards() {
  var newWidth = window.innerWidth;
  clearAllCards();
  if (newWidth < 768) {
    renderMobileNotAvalibleCards(_mock.CARDS, notAlalibleCardContainer);
    renderMobileCards(_mock.CARDS, cardContainer);
  } else {
    renderNotAvalibleCards(_mock.CARDS, notAlalibleCardContainer);
    renderCards(_mock.CARDS, cardContainer);
  }
  (0, _amountCardInCart.updateAmountCardCart)(headerCart);
  (0, _amountCardInCart.updateAmountCardCart)(tabbarCart);
};
renderActualCards();
window.addEventListener('resize', renderActualCards);

},{"./amount-card-in-cart.js":3,"./counter.js":5,"./mock.js":7,"./objects.js":9,"./price-update.js":11,"./total.js":14}],5:[function(require,module,exports){
"use strict";
...
},{"./mock.js":7,"./price-update.js":11,"./search-card.js":13,"./total.js":14}],6:[function(require,module,exports){
"use strict";
...
},{"./mock":7}],7:[function(require,module,exports){
"use strict";
...
var deliveryDateButton = document.querySelector('.delivery-type__setting-button');
var bankCardBasketButton = document.querySelector('.payment-basket__setting-button');
...
},{"./objects":9}],9:[function(require,module,exports){
"use strict";
...
},{"./mock.js":7}],11:[function(require,module,exports){
"use strict";
...
var updatePrice = function updatePrice(priceContainer, data) {
  ...
  actualPrice.textContent = (0, _total.prettierPrice)(Math.ceil(data.amount * data.actualPrice));
  oldPrice.textContent = (0, _total.prettierPrice)(Math.ceil(data.amount * data.oldPrice)) + 'сом';
...
},{"./total.js":14}],12:[function(require,module,exports){
"use strict";
...
},{"./objects.js":9}],13:[function(require,module,exports){
"use strict";
...
exports.updateTotalPrice = exports.updateDeliveryButton = exports.setSelectedCardListiner = exports.prettierPrice = void 0;
var _mock = require("./mock");
var _objects = require("./objects");
...
exports.prettierPrice = prettierPrice;
...
var updateTotalPrice = function updateTotalPrice(selector) {
...
var setSelectedCardListiner = function setSelectedCardListiner(card, selector) {
...
},{"./mock":7,"./objects":9}],15:[function(require,module,exports){
"use strict";

var form = document.querySelector('.recipient__form');
var submitButton = document.querySelector('.total__buy');
var nameInput = form.querySelector('.recipient__name');
var nameContainer = form.querySelector('.recipient__name-container');
var surnameInput = form.querySelector('.recipient__surname');
var surnameContainer = form.querySelector('.recipient__surname-container');
var emailInput = form.querySelector('.recipient__email');
var emailContainer = form.querySelector('.recipient__email-container');
var phoneInput = form.querySelector('.recipient__number');
var phoneContainer = form.querySelector('.recipient__number-container');
var innInput = form.querySelector('.recipient__id');
var innContainer = form.querySelector('.recipient__id-container');
var innDescription = form.querySelector('.recipient__id-description');
var raisesPlaceholder = function raisesPlaceholder(container) {
...
var phonePritier = function phonePritier() {
  var value = phoneInput.value.split();
  value.splice(1, 0, '');
  value.splice(5, 0, '');
  value.splice(9, 0, '');
  value.splice(12, 0, '');
...
var addErrorClass = function addErrorClass(input) {
  input.classList.add('recipient__error');
};
var removeErrorClass = function removeErrorClass(input) {
  input.classList.remove('recipient__error');
};
var showErrorMessageValidaton = function showErrorMessageValidaton(container) {
  raisesPlaceholder(container);
  container.querySelector('.recipient__error-message').classList.remove('visually-hidden');
};
var hideErrorMessageValidation = function hideErrorMessageValidation(container) {
  container.querySelector('.recipient__error-message').classList.add('visually-hidden');
};
var checkName = function checkName() {
  return /^[\u0401\u0410-\u044F\u0451]+$/.test(nameInput.value) || /^[a-zA-Z]+$/.test(nameInput.value);
};
var checkSurname = function checkSurname() {
  return /^[\u0401\u0410-\u044F\u0451]+$/.test(surnameInput.value) || /^[a-zA-Z]+$/.test(surnameInput.value);
};
...
var checkInn = function checkInn() {
...
var customValidation = function customValidation() {
  ...
  if (!checkInn()) {
    ...
    innInput.addEventListener('change', function () {
      if (checkInn()) {
