...
var renderCard = function renderCard(card, place) {
  ...
  (0, _counter.getCounter)(newCard);
  place.append(newCard);
};
exports.renderCard = renderCard;
renderCard(_mock.CARD, document.querySelector('.product__card-container'));

},{"./counter.js":3,"./mock.js":4}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeCounter = exports.getCounter = void 0;
var _mock = require("./mock.js");
var startsCounting = function startsCounting(event) {
  ...
  if (value >= _mock.CARD.maxAmount) {
    add.classList.add('counter__button--disabled');
    value = _mock.CARD.maxAmount;
  } else {
...
var getCounter = function getCounter(card) {
