...
},{"./counter.js":3,"./mock.js":4,"./objects.js":5,"./price-update.js":6}],3:[function(require,module,exports){
"use strict";
...
var startsCounting = function startsCounting(event) {
  ...
  priceIndicatorContainer.querySelector('.card__actual-price').textContent = "".concat(value * CARD.actualPrice, " \u0441\u043E\u043C");
  priceIndicatorContainer.querySelector('.card__past-price').textContent = "".concat(value * CARD.oldPrice, " \u0441\u043E\u043C");
  (0, _priceUpdate.updatePrice)();
};
...
},{"./mock.js":4,"./price-update.js":6}],4:[function(require,module,exports){
"use strict";
...
exports.basket = exports.LOW_PRODUCT_AMOUNT = void 0;
...
var updatePrice = function updatePrice(priceContainer, data) {
  ...
  actualPrice.textContent = "".concat(data.amount * data.actualPrice, " \u0441\u043E\u043C");
  oldPrice.textContent = "".concat(data.amount * data.oldPrice, " \u0441\u043E\u043C");
