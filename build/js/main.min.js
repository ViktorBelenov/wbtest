...
},{"./modules/card.js":2,"./modules/product-show.js":6}],2:[function(require,module,exports){
"use strict";
...
var getCard = function getCard(element) {
  ...
  cardElement.querySelector('.card__actual-price').textContent = "".concat(element.amount * element.actualPrice, " \u0441\u043E\u043C");
  cardElement.querySelector('.card__past-price').textContent = "".concat(element.amount * element.oldPrice, " \u0441\u043E\u043C");
  return cardElement;
};
...
var startsCounting = function startsCounting(event) {
  ...
  priceIndicatorContainer.querySelector('.card__actual-price').textContent = "".concat(value * _mock.CARD.actualPrice, " \u0441\u043E\u043C");
  priceIndicatorContainer.querySelector('.card__past-price').textContent = "".concat(value * _mock.CARD.oldPrice, " \u0441\u043E\u043C");
};
